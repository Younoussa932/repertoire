...
<div class="container">
    <h1 style="text-align : center;">Modification de <strong style="color: blue;"><?= $personne['nom']. ' '.$personne['prenom'];?> </strong></h1>
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <img src="images/<?= $personne["image"] ?>" width="auto" height="50%" class="card-img-top" alt="...">
            </div>
        </div>
        <div class="col-md-9">
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row m-5">
                <div class="col-md-4">
                    ...
                    <input type="text" id="nom" name="nom" value="<?= $personne['nom'];?>" placeholder="Votre Nom" required class="form-control">
                </div>
                <div class="col-md-4">
                    <label for="prenom">Prenom:</label>
                    <input type="text" id="prenom" name="prenom" value="<?= $personne['prenom'];?>" placeholder="Votre Prénom" required class="form-control">
                </div>
                <div class="col-md-4">
