        ...
        <div class="mt-3">
            <div class="row pt-5">
                ...
                <div class="col-md-4">  
                    ...
                    <input type="text" id="prenom" name="prenom" placeholder="Votre Prenom" required class="form-control">
                </div>
                <div class="col-md-4">
            ...
            <div class="row pt-4">
                ...
                <div class="col-md-5">
                    ...
                    <input type="password" id="Cpassword" name="Cpassword" placeholder="confirmer votre mot de passe" required class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mt-5 mb-5">
                    <input class="btn btn-primary" style="text-align: center;" type="submit" name="valide" value="Envoyer">
                </div>
            </div>
        </div>
    </form>
