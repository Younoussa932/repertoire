...
<div class="container">
    <h1 style="text-align : center;">Ajout de contact de <strong style="color: blue;"> <?= $personne['nom'].' '.$personne['prenom'];?> </strong></h1>
    <form action="" method="POST">
        <div class="row m-5">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="contact" name="contact"  placeholder="Ajouter un contact" required class="form-control">
            </div>
        </div>
        <div class="row">
